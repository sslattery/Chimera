...
\begin{frame}{Thermal Convection Cavity Results}
  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      ...
      \begin{itemize}
      \item Weaker preconditioning at \sn{1}{-5} case
      \item Forcing term method adapts to nonlinear convergence
      \item Constant forcing term for \sn{1}{-6} case
      \end{itemize}
...
%%---------------------------------------------------------------------------%%
\begin{frame}{Iterative Performance Summary}
