...
{\tiny  \begin{table}[h!]
    ...
    \caption{Spectral radius results for the block Jacobi
      preconditioned $SP_N$ iteration matrix with 10 energy groups and
      full downscatter.}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{figure}[t!]
        \begin{center}
          \includegraphics[width=2.25in]{block_jacobi_res.pdf}
        \end{center}
      \end{figure}
...
\begin{frame}{FANM Numerical Experiments}
  ...
  \begin{itemize}
    ...
    \item All methods and problems preconditioned with explicit scheme
      using algebraic multigrid (ML) with RDA and leveraged some kind
      of globalization (e.g. backtracking) }
  \end{itemize}
