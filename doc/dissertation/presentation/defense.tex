...
\begin{frame}{Research Outline}
  ...
  \item Development of a nonlinear solver for discrete systems
    ...
    \begin{itemize}
    \item Application to fluid flow
    \item Potential memory benefits
...
\begin{frame}{Monte Carlo Linear Solvers Library (MCLS)}
  ...
  \begin{itemize}
  \item Preliminary development during January of 2013
    \bigskip
...
\begin{frame}{Fuel Assembly Results}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{figure}[htpb!]
        \begin{center}
          \includegraphics[width=1.9in]{solver_iters.pdf}
        \end{center}
      \end{figure}
  ...
  \begin{table}[h!]
    \begin{center}
      \begin{tabular}{lcc}\hline\hline
        ...
        \hline
        Convection, Ra=\sn{1}{3} & 5 & 5 \\
        Convection, Ra=\sn{1}{4} & 7 & 7 \\
        Convection, Ra=\sn{1}{5} & 9 & 10 \\
        Convection, Ra=\sn{1}{6} & 11 & 11 \\
        \hline
        Lid Driven, Re=100 & 6 & 6 \\
        Lid Driven, Re=300 & 9 & 9 \\
        Lid Driven, Re=500 & 11 & 11 \\
        Lid Driven, Re=700 & 14 & 10 \\
        \hline
        Backward Step, Re=200 & 10 & 9 \\
        Backward Step, Re=300 & 15 & 14 \\
        Backward Step, Re=400 & 10 & 10 \\
        Backward Step, Re=500 & 19 & 20 \\
        %%
        \hline\hline
      \end{tabular}`
    \end{center}
  ...
  \begin{table}[h!]
    \begin{center}
      \begin{tabular}{lcc}\hline\hline
        ...
        \multicolumn{1}{c}{FANM}\\
        \hline
        Convection, Ra=\sn{1}{3} & 32 & 18 \\
        Convection, Ra=\sn{1}{4} & 23 & 17 \\
        Convection, Ra=\sn{1}{5} & 25 & 20 \\
        Convection, Ra=\sn{1}{6} & 39 & 25 \\
        \hline
        Lid Driven, Re=100 & 27 & 42 \\
        Lid Driven, Re=300 & 35 & 52 \\
        Lid Driven, Re=500 & 41 & 56 \\
        Lid Driven, Re=700 & 21 & 14 \\
        \hline
        Backward Step, Re=200 & 24 & 13 \\
        Backward Step, Re=300 & 23 & 17 \\
        Backward Step, Re=400 & 18 & 12 \\
        Backward Step, Re=500 & 30 & 52 \\
        %%
        \hline\hline
      \end{tabular}
    \end{center}
