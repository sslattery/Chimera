...
\times 200$ grid was used with 40,000 histories at every iterations
with the expected value estimator. To reduce the effect of the weight
cutoff on this study, the weight cutoff was set to \sn{1}{-12} such
that it is signicantly more likely that a history will be terminated
by absorption rather than weight cutoff. Compare CPU time and
iterative performance with a fixed grid.
