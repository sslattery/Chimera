...
\cite{evans_simpli_2013}\footnote{The $SP_N$ derivations in this
  chapter and the associated appendices are heavily based on those
  presented by Evans in \cite{evans_simpli_2013}}, in order to gain
...
'pseudo-moment' $u_n$. As noted by Evans \cite{evans_simpli_2013},
...
\cite{evans_simpli_2013}. We again apply the change of variables to
