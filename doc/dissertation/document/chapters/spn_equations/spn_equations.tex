...
\subsection{Fixed-Source Monoenergetic $SP_N$ Equations}
...
\subsection{Eigenvalue Form of the Multigroup $SP_N$ Equations}
...
\sn{3}{4} histories at each MCSA iteration to compute the Monte Carlo
