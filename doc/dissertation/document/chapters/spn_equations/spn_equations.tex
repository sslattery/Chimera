...
The $P_N$ equations as derived in \citep{lewis_computational_1993}
...
\citep{evans_simpli_2013}. We again apply the change of variables to
...
\begin{figure}[t!]
  \begin{center}
    \includegraphics[width=5in]{chapters/spn_equations/solver_iters.pdf}
  \end{center}
