...
equations \citep{ghia_high-re_1982,evans_enhanced_2007}. Without
...
therefore no solution is acquired.
...
Newton-Krylov method although this is not conclusive enough to claim
superior performance converging the nonlinear residual with FANM. As
observed for each benchmark, the timing results were always in favor
of the Newton-Krylov method due to the effects of the explict
