...
Jacobian most commonly used in today's applications. Following this, a
new algorithm utilizing Monte Carlo Synthetic Acceleration will be
...
obtained using conventional methods in various flow regimes and
...
in \cite{pawlowski_globalization_2006} while the forcing term was
...
difficult to solve and therefore a more aggressive preconditioner
...
\begin{figure}[t!]
  ...
  \caption{\textbf{Thermal convection cavity linear solver iterations
      ...
      forcing term was fixed at \sn{1}{-4} at all nonlinear
      iterations.}}
...
\begin{figure}[t!]
  ...
  \caption{\textbf{Lid driven cavity forcing terms as a function of
      ...
      forcing terms were much larger.}}
...
the linear model. This is indeed the case for the 400 Reynolds number
case where the linear model is better conditioned and FANM used fewer
