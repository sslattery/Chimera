...
the variables. Traditionally, such systems have been solved by
...
method relative to solutions obtained using conventional
methods. Finally, will compare the performance of the new method
against contemporary Newton-Krylov methods for the benchmark problems.
...
\citep{kelley_iterative_1995}. As we outlined in
...
parallel, defering the bulk of the discussion on parallel methods
