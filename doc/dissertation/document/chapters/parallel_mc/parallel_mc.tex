...
following are the signficant observations and findings.
...
\item Strong scaling studies were performed with up to 65,536 cores
  and weak scaling studies were performed with up to 131,072 cores
\item MCSA scales comparably to production Krylov methods on the Titan
  Cray XK7 leadership class machine
...
\item Multiple sets will never boost parallel efficienicies in both
...
\item Multiple sets offers a means to reduce time to solution by
  solving a multiple copies of the original problem and combining the
  solutions using superposition
\item MCSA is most efficient used in parallel as a stochastic
