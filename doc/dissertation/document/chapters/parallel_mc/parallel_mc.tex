...
considered. In this chapter we review particle transport methods for
domain decomposed Monte Carlo and then devise an algorithm based on
these methods for efficient parallel solutions using the adjoint
Neumann-Ulam method and MCSA.
