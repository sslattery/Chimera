...
iterative performance and thus increase compute times. Supplemenatary
scaling studies using the subdomain Neumann-Ulam method with multiple
sets are presented in Appendix~\ref{chap:extra_scaling}.
