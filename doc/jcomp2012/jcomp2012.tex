...
\begin{equation}
  ...
  \end{split}
\end{equation}
Using this series, we can write an iterative method, known as Richardson's
...
cutoff of \sn{1}{-4} for the stochastic linear solver and a convergence
...
started with \sn{1.25}{-9}~ns and increased to 0.01~ns using a maximum change
