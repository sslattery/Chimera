...
method~\cite{halton_1962,halton_1994} to the one-dimensional equilibrium
...
our method to three spatial dimensions, we have realized that the Sequential
Monte Carlo method is actually a variant of iterative refinement cast as a
residual method. We have developed a new method in which Monte Carlo is used
to accelerate a fixed-point (Richardson) iteration. This algorithm surpasses
our previous one dimensional method and allows for extension to more general
solution techniques.
...
using Monte Carlo Synthetic-Accleration to solve the discrete radiation
