...
equations with $\phi_{N+1} = 0$. As a further modification to these
equations, we can use a change of variables to create a new group of
equations such that the gradients are operating on a single vector. As
a concrete example, we will consider the $SP_7$ equations:
\begin{subequations}
  \begin{gather}
    -\nabla \cdot \frac{1}{3 \Sigma_1} \nabla ( \phi_0 + \phi_2 ) +
    \Sigma_0 \phi_0 = q \\ 
    -\nabla \cdot \Bigg[ \frac{2}{15 \Sigma_1} \nabla ( \phi_0 + \phi_2
      ) + \frac{3}{35 \Sigma_3}( 3\phi_2 + 4\phi_4)\Bigg] + \Sigma_2
    \phi_2 = 0\\
    -\nabla \cdot \Bigg[ \frac{4}{63 \Sigma_3} \nabla ( 3\phi_2 +
      4\phi_4 ) + \frac{5}{99 \Sigma_5}( 5\phi_4 + 6\phi_6)\Bigg] +
    \Sigma_4 \phi_4 = 0\\
    -\nabla \cdot \Bigg[ \frac{6}{143 \Sigma_5} \nabla ( 5\phi_4 +
      6\phi_6 ) + \frac{7}{195 \Sigma_7}( 7\phi_6)\Bigg] + \Sigma_6
    \phi_6 = 0 
  \end{gather}
