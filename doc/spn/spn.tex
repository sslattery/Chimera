...
effective means of solution. As the solution is asymmetric, modern
iterative solvers should be considered for this task. The performance
of modern subspace methods are bound to various properties of the
...
\subsection{Stationary Methods for Asymmetric Linear Systems}
...
\subsection{Subspace Methods for Asymmetric Linear Systems}
...
\cite{nachtigal_how_1992} that performs and in-depth analysis of 3
...
biconjugate gradient-based method (CGS).
