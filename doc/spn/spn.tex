...
\begin{equation}
  \sum_{n=0}^\infty \frac{\partial}{\partial x} \frac{1}{n+1} \Big[
...
The laste term we are concerned with in Eq~(\ref{eq:pn_deriv_1}) is
the source term:
\begin{equation}
...
\begin{equation}
   \frac{1}{n+1} \frac{\partial}{\partial x}\Big[ (n+1) \phi_{n+1} + n
...
at some level of approximation such that $n = 0,1,\dotsc,N$. This
...
the series truncation as an approximation we choose:
\begin{equation}
  \phi_{N+1} = 0\:.
  \label{eq:pn_closure}
\end{equation}
...
\begin{subequations}
  \begin{gather}
   ...
   \frac{1}{2} \frac{\partial}{\partial x}\Big[ 2
     \phi_{2} + \phi_{0} \Big] + \Sigma_1 \phi_1 = 0\:,\\
   \frac{1}{3} \frac{\partial}{\partial x}\Big[ 3 \phi_{3} + 2
     \phi_{1} \Big] + \Sigma_2 \phi_2 = 0 \:,\\
   \frac{1}{4} \frac{\partial}{\partial x}\Big[ 4 \phi_{4} + 3
     \phi_{2} \Big] + \Sigma_3 \phi_3 = 0 \:,\\
   \frac{1}{5} \frac{\partial}{\partial x}\Big[ 5 \phi_{5} + 4
     \phi_{3} \Big] + \Sigma_4 \phi_4 = 0 \:,\\
   \frac{1}{n+1} \frac{\partial}{\partial x} 5 \phi_{4} + \Sigma_5
   \phi_5 = 0 \:.
  \end{gather}
