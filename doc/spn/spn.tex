...
\begin{multline}
    ...
    \frac{4}{15}u_3 + \frac{8}{35}u_4\Big)
    +\\ \frac{1}{7\Sigma_3}\hat{\mathbf{n}}\cdot\nabla\Big(3\Big(\frac{1}{3}u_2
    - \frac{4}{15}u_3 + \frac{8}{35}u_4\Big) + 4\Big(\frac{1}{5}u_3 -
    \frac{6}{35}u_4\Big)\Big) + \frac{81}{128}\Big(\frac{1}{5}u_3
    -\\ \frac{6}{35}u_4\Big) - \frac{13}{64}\Big(\frac{1}{7}u_4\Big) =
    -\frac{1}{8}\phi_{b}\:,
\end{multline}
\begin{multline}
...
\begin{multline}
    ...
    +\\ \frac{1}{15\Sigma_7}\hat{\mathbf{n}}\cdot\nabla\Big(7\Big(\frac{1}{7}u_4\Big)\Big)
    = -\frac{5}{128}\phi_{b}\:.
\end{multline}
...
neutron transport equation for a single dimension for planar geometry:
\begin{multline}
...
\end{multline}
where $g$ denotes the group index of $0$ to $G$ groups where $G=N_g-1$
and the integration of the scattering emission term of energy has been
...
\begin{equation}
  -\nabla \cdot \mathbb{D} \nabla \mathbb{U} + \mathbb{A} \mathbb{U} =
  \mathbb{Q}\:,
...
generated from the moment scattering matrices. Analogously, on the
boundaries we have:
\begin{equation}
  \hat{\mathbf{n}} \cdot \mathbb{D} \nabla \mathbb{U} + \mathbb{B}
  \mathbb{U} = \mathbb{S}\:.
