...
\newcommand{\authorHead}      % Author's names here
   {Stuart R. Slattery and Paul P.H. Wilson and Thomas M. Evans}  
...
\begin{center}
\textbf{\large \\% 
  A Spectral Analysis of the Domain Decomposed
  Adjoint Neumann-Ulam Monte Carlo Method for Linear Operator
  Equations}
% 
% FIRST AUTHORS 
%
...
\textbf{Stuart R. Slattery and Paul P.H. Wilson}\footnote{Please send
  correspondence to sslattery@wisc.edu} \\
