...
\begin{abstract}
  ...
  length of the random walks and the fraction of histories leaking
...
all boundaries of the domain. For our problems, we choose the
...
of grid points beyond the boundary of the grid. We set the flux at
