...
\begin{abstract}
  ...
  diffusion theory. Using the leakage fraction estimate, Wigner
  rational approximation and the mean chord approximation are applied
  to estimate the leakage fraction. The one-speed, two-dimensional
  neutron diffusion equation is used as a model problem to test the
  spectral theory for symmetric operators. In general, the spectral
  theory and derived approximations show good agreement with measured
...
\sn{3}{5} histories were sampled from a uniform source of strength
