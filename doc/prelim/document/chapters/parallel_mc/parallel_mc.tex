...
adjoint method. We begin with defining the linear system adjoint to
...
respectively. We can split this equation to mirror
...
\end{equation}
With this statement we can then define split equation.:
\begin{equation}
...
\end{equation}
By comparing the contents of their estimators, we can determine
$\ve{y}$ and $\ve{d}$ from the direct method. In this scheme,
random walk histories are born in a state generated by source sampling
and tallies are generated in the states in which the random walk
currently resides.
...
walk currently resides, the contribution to the solution in state $i$
