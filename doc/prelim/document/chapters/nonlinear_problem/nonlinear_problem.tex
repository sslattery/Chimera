...
\[
  \begin{array}{lccccccccccccccc}
    ...
    & 5 & 5 & 6 \\ row\ start: & 3 & 5 & 9 & 12 & 14 & 16 \\
  \end{array}
\]
...
index rows that each matrix row starts at. For this simple example, we
actually break even by storing 36 elements in the full matrix and 36
pieces of data in the compressed format. However, for large, sparse
matrices there is a significant storage savings using the compressed
format. 
