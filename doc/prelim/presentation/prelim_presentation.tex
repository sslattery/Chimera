...
\begin{frame}{Projection Methods Summary}
  ...
  \item Nearest neighbor computations have poor algorithmic strong
    ...
    \end{itemize}
  \item Short and long reccurrence relations available for
    orthogonalization
  \end{itemize}
...
\begin{frame}{Domain-to-Domain Communication}
  ...
  \begin{itemize}
  \item Sigel observed $\lambda$ to be bound empirically to the mean
  ...
  \item How do we define $\lambda$ empirically for linear operator
    equations? 
  \item Full-clip roullette for the MCSA correction?
  \end{itemize}
...
\begin{frame}{Reproducability}
  ...
  \begin{figure}[htpb!]
    \begin{center}
      \scalebox{0.7}{ \input{gentile_example.pdftex_t} }
    \end{center}
  ...
  \begin{itemize}
  \item 2005 work by Gentile outlines reproducability in parallel
    Monte carlo
...
Questions
  ...
  \item Will full-clip roullette perturb the MCSA solution?
